      ...
      <div className="container max-w-md mx-auto p-4">
        <div className="flex flex-col items-start space-y-4">
          ...
          <p className="text-gray-600 text-sm">
            Quickly measure your heart rate, blood pressure, and stress levels
            through facial analysis. Ensure good lighting and remain still
            during the scan.
          </p>
                  ...
                  <div className="bg-blue-50 p-3 rounded-lg mt-2">
                    <div className="flex items-start">
                      ...
                      <p className="text-xs text-blue-700">
                        Our AI technology analyzes subtle variations in your
                        face to measure vital signs and health metrics.
                      </p>
                    </div>
                  </div>
                </div>
