...
const MealEditPage = () => {
  ...
  useEffect(() => {
    ...
    if (location.state?.meal) {
      ...
      const structuredIngredients = (meal.ingredients || []).map((ing: string, index: number) => ({
        id: `ing-${index}`,
        name: ing,
    ...
    <Layout>
      <div className="container mx-auto px-4 pb-24">
        <div className="p-4 flex flex-row items-center justify-between border-b sticky top-0 bg-white z-10">
          <Button variant="ghost" size="icon" onClick={handleBack} className="h-10 w-10 rounded-full bg-gray-100">
        ...
        <div className="p-4 space-y-6">
          ...
          <div className="space-y-2">
            <Label htmlFor="meal-name" className="text-gray-600">Meal Name</Label>
            <Input
              id="meal-name"
              value={mealName}
          ...
          {/* Meal Type */}
          <div className="space-y-2">
            <Label htmlFor="meal-type" className="text-gray-600">Meal Type</Label>
            <Select value={mealType} onValueChange={setMealType}>
              <SelectTrigger id="meal-type" className="bg-gray-50 flex justify-between">
          ...
          <div className="space-y-3">
            ...
            <div className="bg-gray-50 p-3 rounded-lg flex items-center justify-between">
              <Label htmlFor="calories" className="text-gray-700 text-lg">Calories</Label>
            ...
            <div className="bg-gray-50 p-3 rounded-lg flex items-center justify-between">
              <Label htmlFor="protein" className="text-gray-700 text-lg">Protein</Label>
              <div className="flex items-center">
                <Input
                  id="protein"
                  type="number"
            ...
            <div className="bg-gray-50 p-3 rounded-lg flex items-center justify-between">
              <Label htmlFor="carbs" className="text-gray-700 text-lg">Carbs</Label>
              <div className="flex items-center">
                <Input
                  id="carbs"
                  type="number"
            ...
            <div className="bg-gray-50 p-3 rounded-lg flex items-center justify-between">
              <Label htmlFor="fat" className="text-gray-700 text-lg">Fat</Label>
              <div className="flex items-center">
                <Input
                  id="fat"
                  type="number"
          ...
          <div className="space-y-3">
            ...
            {ingredients.map((ingredient) => (
              <div key={ingredient.id} className="bg-gray-50 p-3 rounded-lg flex items-center justify-between gap-2">
                <div className="w-1/3">
                  {ingredient.warning && (
