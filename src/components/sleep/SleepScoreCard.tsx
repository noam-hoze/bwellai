...
const SleepScoreCard = ({
  ...
  return (
    <Card
      className={`wellness-card border-l-4 border-l-wellness-deep-orange h-full bg-[#f9fafb] text-black ${className}`}
    >
            ...
            <Tooltip>
              ...
              <TooltipContent className="w-80 p-3">
                <div className="space-y-2">
                  ...
                  <p className="text-xs">
                    Your Sleep Score is calculated based on five key factors:
                  </p>
                  <ul className="list-disc pl-5 text-xs space-y-1">
                    <li>
                      <span className="font-medium">Total Sleep (30%)</span> –
                      How close you are to the recommended sleep duration.
                    </li>
                    <li>
                      <span className="font-medium">Sleep Stages (30%)</span> –
                      The balance of Light, Deep, and REM sleep.
                    </li>
                    <li>
                      <span className="font-medium">Wake Events (15%)</span> –
                      How often and how long you were awake during the night.
                    </li>
                    <li>
                    ...
                    <li>
                      <span className="font-medium">Recovery (10%)</span> –
