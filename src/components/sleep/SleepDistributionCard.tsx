            ...
            <Tooltip>
              ...
              <TooltipContent className="w-80 p-3">
                <div className="space-y-2">
                  ...
                  <p className="text-xs">The chart shows your actual sleep stages compared to ideal amounts:</p>
                  <ul className="list-disc pl-5 text-xs space-y-1">
                    <li><span className="font-medium text-[#FEDF89]">Light Sleep:</span> 50-60% of total sleep time</li>
                    <li><span className="font-medium text-[#53A15E]">Deep Sleep:</span> 15-25% of total sleep time</li>
                    <li><span className="font-medium text-[#0EA5E9]">REM Sleep:</span> 20-25% of total sleep time</li>
                    <li><span className="font-medium text-[#F97316]">Awake Time:</span> Less than 10% is ideal</li>
                  </ul>
                  <p className="text-xs mt-2">A balanced sleep cycle includes sufficient amounts of each sleep stage for optimal rest and recovery.</p>
                </div>
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
      ...
      <CardContent className="pt-0 h-full">
        <div className="h-72 w-full">
          <div className="relative h-full w-full flex flex-col items-center justify-center">
            ...
            {/* Center text showing dominant sleep stage */}
