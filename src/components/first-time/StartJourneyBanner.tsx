  ...
  return (
    ...
    >
      <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
        <div>
          <h2 className="text-2xl font-bold text-gray-800 mb-2">Start Your Journey with BWellAI</h2>
          <p className="text-gray-600">Let's set up your personalized wellness experience together</p>
        </div>
        <Button 
          onClick={openJourney}
