...
const BodyModelEnhanced = () => {
  ...
  const [selectedRegion, setSelectedRegion] = useState({
    ...
    trendData: [
      65, 67, 64, 66, 68, 65, 67, 69, 68, 70, 68, 66, 67, 68, 69, 67, 66, 68,
      67, 68, 69, 67, 68, 69, 70, 68, 68, 69, 68, 68,
    ],
  });
                  ...
                  <div className="h-24 w-full">
                    <svg viewBox="0 0 300 100" className="w-full h-full">
                      <polyline
                        ...
                        stroke="#33D685"
                        strokeWidth="2"
                        points={selectedRegion.trendData
                          .map(
                            (value, index) => `${index * 10}, ${100 - value}`
                          )
                          .join(" ")}
                      />
                    </svg>
        ...
        <ResizablePanel defaultSize={25}>
          <div className="h-full p-4 flex flex-col">
            ...
            <div className="bg-wellness-light-green p-4 rounded-lg">
              <h5 className="font-medium text-wellness-bright-green mb-2">
                Heart Health Champion
              </h5>
              <p className="text-sm mb-3">
                Your heart metrics have been optimal for 30+ days
              </p>
