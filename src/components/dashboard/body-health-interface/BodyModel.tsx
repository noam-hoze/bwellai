...
const bodyImageUrl = "/lovable-uploads/d7268c72-011c-45d3-8b5e-599565846313.png";
...
const healthRegions = [
  ...
  { id: "muscular-region", position: { top: "50%", left: "50%" }, size: "100px" },
  { id: "hydration-region", position: { top: "45%", left: "50%" }, size: "80px" }
];
...
const BodyModel: React.FC<BodyModelProps> = ({ selectedSystem, rotation, zoom }) => {
