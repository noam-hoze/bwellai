    ...
    <Card className="border-2 border-dashed border-gray-200 bg-gray-50">
      <CardHeader className="text-center pb-2">
        ...
        <CardDescription className="text-gray-500">
          Connect your devices and apps to get the most out of your health
          journey
        </CardDescription>
      </CardHeader>
      ...
      <CardContent className="text-center space-y-4 px-4 sm:px-8">
        <div className="bg-blue-50 rounded-lg p-4 max-w-md mx-auto">
          ...
          <p className="text-sm text-gray-600">
            Users who connect devices are <strong>3x more likely</strong> to
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-2xl mx-auto">
          <div className="bg-white rounded-lg p-4 border border-gray-200">
            ...
            <p className="text-xs text-gray-500">
              Choose a device or app to connect
            </p>
          </div>
          <div className="bg-white rounded-lg p-4 border border-gray-200">
