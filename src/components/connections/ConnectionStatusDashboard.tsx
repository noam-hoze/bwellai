...
const ConnectionStatusDashboard = ({
  ...
  const connectionProgress =
    (connectedDevicesData?.length / stats.totalAvailable) * 100;
        ...
        <CardContent className="p-6">
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <h3 className="text-3xl font-bold">
                {connectedDevicesData?.length} of {stats.totalAvailable}
              </h3>
              <p className="text-sm text-gray-500">
                available integrations active
              </p>
            </div>
            <div className="text-right">
              <Progress
                value={connectionProgress}
                className="w-[100px] h-2 mb-1"
              />
              <p className="text-sm text-gray-500">
                {Math.round(connectionProgress)}% connected
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-4 mt-6">
            ...
            <div className="bg-blue-50 border border-blue-100 rounded-lg p-4 flex flex-col items-center">
              ...
              <Badge
                variant="outline"
                className="mt-1 bg-blue-50 text-blue-600 border-blue-200"
              >
                Suggested
              </Badge>
            </div>
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 flex flex-col items-center">
              ...
              <p className="text-2xl font-semibold mt-1">
                {stats.totalAvailable - connectedDevicesData?.length}
              </p>
              <Badge
                variant="outline"
