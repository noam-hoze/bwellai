...
const ConnectionCategorySection = ({ category, onConnect }: ConnectionCategorySectionProps) => {
  return (
            ...
            {category.integrations.map(integration => (
              <Card key={integration.id} className="bg-white">
                <CardContent className="p-4 flex justify-between items-center">
                  <div className="flex items-center">
                    <div className="bg-blue-50 p-1.5 rounded-full mr-2 flex items-center justify-center" style={{ width: 32, height: 32 }}>
