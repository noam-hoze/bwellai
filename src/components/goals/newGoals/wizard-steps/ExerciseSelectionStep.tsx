...
interface ExerciseSelectionStepProps {
  goalData: GoalData;
  updateGoalData: (data: Partial<GoalData>) => void;
}

// Sample exercise data with proper types
const exercisesByCategory: Record<string, Exercise[]> = {
  "Stretching": [
    ...
    },
    {
      ...
      name: "Child's Pose",
      category: "Stretching",
      description: "Relaxes the lower back and promotes flexibility in the hips",
      recommendedReps: 3,
      customReps: 3,
      sets: 1,
  ...
  "Strengthening": [
    ...
    },
    {
      ...
      customReps: 12,
      sets: 2,
      imageUrl: "https://images.unsplash.com/photo-1469474968028-56623f02e42e?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.0.3",
      videoUrl: "#",
      selected: false
    }
  ],
  "Mobility": [
    {
      ...
      customReps: 6,
      sets: 2,
      imageUrl: "https://images.unsplash.com/photo-1509316975850-ff9c5deb0cd9?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.0.3",
      videoUrl: "#",
      selected: false
    },
    {
      ...
      category: "Mobility",
      description: "Stretches tight hamstrings which can contribute to back pain",
      recommendedReps: 4,
      customReps: 4,
      sets: 1,
      imageUrl: "https://images.unsplash.com/photo-1465146344425-f00d5f5c8f07?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.0.3",
...
const ExerciseSelectionStep = ({ goalData, updateGoalData }: ExerciseSelectionStepProps) => {
  ...
  const toggleExerciseSelection = (exercise: Exercise) => {
    const updatedExercises = goalData.selectedExercises.some(e => e.id === exercise.id)
  ...
  return (
    <div className="space-y-6">
                        ...
                        <div className="flex items-center">
                          <Button
                            ...
                            onClick={() => {
                              ...
                              if (currentReps > 1) {
                                updateExerciseReps(exercise.id, currentReps - 1);
                              }
                            }}
                          >
                          ...
                          <Input
                            ...
                            value={getCustomReps(exercise.id) || exercise.recommendedReps}
                            onChange={(e) => updateExerciseReps(exercise.id, parseInt(e.target.value) || 1)}
                            min="1"
                          />
                          <Button
                            variant="outline"
      ...
      {videoPreviewExercise && (
        <Dialog open={!!videoPreviewExercise} onOpenChange={() => setVideoPreviewExercise(null)}>
            ...
            <div className="aspect-video bg-gray-100 flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-xs text-gray-400 mt-1">
                  (In a real application, this would play the actual exercise video)
                </p>
              </div>
            </div>
          </DialogContent>
