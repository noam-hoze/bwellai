...
import { GoalData, PainTrigger, PainPattern } from "../CreateGoalWizard";
...
const PainAssessmentStep = ({ goalData, updateGoalData }: PainAssessmentStepProps) => {
  ...
  const handlePainPatternChange = (pattern: PainPattern) => {
    updateGoalData({
      painPattern: pattern
    });
  };

  const handlePainTriggerToggle = (trigger: PainTrigger) => {
  ...
  // Define valid pain triggers matching the type
  const painTriggers: PainTrigger[] = [
        ...
        >
          <div className="space-y-3">
            ...
            <div className="flex items-center space-x-2">
              ...
              <Label htmlFor="activity-related">Activity-related (worse with specific movements)</Label>
            </div>
            <div className="flex items-center space-x-2">
