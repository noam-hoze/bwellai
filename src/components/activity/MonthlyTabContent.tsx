    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <Card className="wellness-card border-l-4 border-l-blue-400 lg:col-span-2">
          ...
          <CardContent>
            <ActivitySummary date={selectedDate} viewType="month" />
          </CardContent>
        </Card>
        ...
        <Card className="wellness-card border-l-4 border-l-blue-400">
          ...
          <CardContent>
            <ActivityRecommendations date={selectedDate} viewType="month" />
          </CardContent>
        </Card>
        ...
        <Card className="lg:col-span-3 wellness-card border-l-4 border-l-blue-400">
          ...
          <CardContent>
            <ActivityChart date={selectedDate} viewType="month" />
          </CardContent>
        </Card>
      </div>
    </div>
